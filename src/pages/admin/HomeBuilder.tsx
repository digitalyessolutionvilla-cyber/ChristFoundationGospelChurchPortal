...
const BUILT_IN_KEYS = ['hero_slider', 'quick_links', 'welcome', 'sunday_school_lesson', 'morning_devotional', 'vision_mission', 'events'];
...
const SECTION_LABELS: Record<string, string> = {
  ...
  morning_devotional: 'Morning Devotional — managed via Page Content',
